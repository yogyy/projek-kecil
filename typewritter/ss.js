...
e.prototype.loop = function () {
  ...
  if (!(this.g && this.b > this.g)) {
    if (0 !== this.b) {
      var b = this.i[Math.floor(this.b - 0.5) % this.i.length];
      this.text = b.substring(0, this.text.length + (this.c ? -1 : 1));
      this.f.innerHTML = '<span class="wrap">' + this.text + "</span>";
      "" === this.text && this.c
        ? ((this.c = !1), (this.b += 0.5), (b = this.h))
        : this.text !== b || this.c
        ? (b =
            this.c && this.j
              ? 50 / this.speed
              : this.l
              ? (200 - 10 * Math.random()) / this.speed
              : 100 / this.speed)
        : ((b = this.endDelay), (this.c = !0), (this.b += 0.5));
    } else (b = this.h), (this.b += 0.5);
    setTimeout(function () {
      return a.loop();
    }, b);
  }
...
function f(a) {
  a.a = g(a.f, function () {
    window.removeEventListener
      ? (removeEventListener("DOMContentLoaded", a.a, !1),
        removeEventListener("load", a.a, !1),
        removeEventListener("scroll", a.a, !1),
        removeEventListener("resize", a.a, !1))
      : window.detachEvent &&
        (detachEvent("onDOMContentLoaded", a.a),
        detachEvent("onload", a.a),
        detachEvent("onscroll", a.a),
        detachEvent("onresize", a.a));
    a.loop();
  });
  window.addEventListener
    ? (addEventListener("DOMContentLoaded", a.a, !1),
      addEventListener("load", a.a, !1),
      addEventListener("scroll", a.a, !1),
      addEventListener("resize", a.a, !1))
    : window.attachEvent &&
      (attachEvent("onDOMContentLoaded", a.a),
      attachEvent("onload", a.a),
      attachEvent("onscroll", a.a),
      attachEvent("onresize", a.a));
  a.a();
}
function g(a, b) {
  var c = !1;
...
window.onload = function () {
  for (
    var a = document.getElementsByClassName("typeWriter"), b = 0;
    b < a.length;
    b++
  ) {
